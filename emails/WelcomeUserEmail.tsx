    ...
    return (
            ...
            <Tailwind>
                ...
                <ul className="space-y-5 *:py-2">
                    <li className="py-2">Ingresa a nuestro sitio web: <Link href="https://www.club-app.xyz">click aquí</Link>👈🏼</li>
                    <li className="py-2">Da click en el botón "INICIAR SESIÓN"</li>
