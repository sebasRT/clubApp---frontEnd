...
const DeleteCoachPopUp = () => {
    ...
    const [deletingState, setDeletingState] = useState<"none" | "security" | "loading" | "done" | "failed">("failed")
                                ...
                                switch (deletingState) {
                                    ...
                                    case "done":
                                        return <div className="flex flex-col gap-20">
                                            ...
                                            <button className="bg-primary-500 text-baltic-sea-50 px-2 py-1 font-bold rounded-[5px] leading-loose"
